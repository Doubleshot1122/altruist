  ...
  return knex('bookings').del()
    .then(function () {
      ...
      return knex('bookings').insert([
        {id: 1, volunteer_id: 1, non_profit_id: 1, startDateTime: '2017-04-28 19:00:00 UTC', endDateTime: '2017-04-28 21:00:00 UTC', status: 1, specialDirections: 'Room 10', volunteerJobAssessment: ''},
